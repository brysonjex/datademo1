...
def main() -> None:
    ...
    parser.add_argument("--output", default="benford_output", help="Directory to write analysis outputs.")
    ...
    detail_df.to_csv(output_dir / "benford_detail.csv", index=False)
    summary_df.to_csv(output_dir / "benford_summary.csv", index=False)
    ...
    summary_lines = [
        ...
        "",
        "## Outputs",
        "- `benford_detail.csv`: per-digit counts and proportions",
        "- `benford_summary.csv`: chi-square and MAD per numeric column",
        "",
        "Generated by `scripts/benford_analysis.py`.",
    ]
