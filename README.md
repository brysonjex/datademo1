...
This repo includes a GitHub Actions workflow that produces basic summary statistics for `je_samples.xlsx`.
...
2. Download the `je-analysis-output` artifact from the workflow run to view the outputs.
